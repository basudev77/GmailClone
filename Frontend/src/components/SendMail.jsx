...
function SendMail() {
  ...
  return (
    <div className={`${open ? 'block' : 'hidden'} bg-white max-w-6xl shadow-xl shadow-slate-600 rounded-t-md`}>
      ...
      <form id="form" onSubmit={submitHandler} className='flex flex-col p-3 gap-2'>
        ...
        <button className='bg-[#0B57D0] rounded-full w-fit px-4 text-white font-medium'>Send</button>
